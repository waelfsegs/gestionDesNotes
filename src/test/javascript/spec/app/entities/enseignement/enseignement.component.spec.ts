...
import { EnseignementComponent } from 'app/entities/enseignement/enseignement.component';
...
describe('Component Tests', () => {
  describe('Enseignement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enseignements && comp.enseignements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
