...
import { EnseignementDeleteDialogComponent } from 'app/entities/enseignement/enseignement-delete-dialog.component';
  ...
  describe('Enseignement Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [EnseignementDeleteDialogComponent],
      })
