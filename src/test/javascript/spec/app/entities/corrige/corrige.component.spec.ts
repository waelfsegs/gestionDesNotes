...
import { CorrigeComponent } from 'app/entities/corrige/corrige.component';
import { CorrigeService } from 'app/entities/corrige/corrige.service';
import { Corrige } from 'app/shared/model/corrige.model';

describe('Component Tests', () => {
  describe('Corrige Management Component', () => {
    let comp: CorrigeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CorrigeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.corriges && comp.corriges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
